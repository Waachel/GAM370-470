...
void ModelTools::CreateUnitBoxSixFaceTexture(StandardVertex*& pVerts, int& nverts, TriangleByIndex*& pTriList, int& ntri)
{
	...
	pVerts[vind + 1].set(-0.5f, 0.5f, 0.5f, 0.25, 0.375);		//top left
	pVerts[vind + 2].set(-0.5f, -0.5f, 0.5f, 0, 0.375);			//bottom left
	...
	vind += 4;
	tind += 2;
	pVerts[vind].set(0.5f, 0.5f, -0.5f, 0.5, 0.625);			//top left
	pVerts[vind + 1].set(-0.5f, 0.5f, -0.5f, 0.5, 0.375);		//top right
	pVerts[vind + 2].set(-0.5f, -0.5f, -0.5f, 0.75, 0.375);		//bottom right
	...
	pVerts[vind + 1].set(0.5f, 0.5f, 0.5f, 0.25, 0.625);				//top left
	pVerts[vind + 2].set(0.5f, -0.5f, 0.5f, 0.25, 0.875);				//bottom left
	pVerts[vind + 3].set(0.5f, -0.5f, -0.5f, 0.5, 0.875);				//bottom right
	pTriList[tind].set(vind, vind + 1, vind + 2);
	pTriList[tind + 1].set(vind, vind + 2, vind + 3);
	...
	vind += 4;
	tind += 2;
	pVerts[vind].set(-0.5f, 0.5f, 0.5f, 0.25, 0.375);				//top right
	pVerts[vind + 1].set(-0.5f, 0.5f, -0.5f, 0.5, 0.375);			//top left
	pVerts[vind + 2].set(-0.5f, -0.5f, -0.5f, 0.5, 0.125);			//bottom left
	pVerts[vind + 3].set(-0.5f, -0.5f, 0.5f, 0.25, 0.125);			//bottom right
	pTriList[tind].set(vind, vind + 1, vind + 2);
	pTriList[tind + 1].set(vind, vind + 2, vind + 3);
