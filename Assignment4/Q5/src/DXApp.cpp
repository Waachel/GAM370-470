...
void DXApp::InitDemo()
{
	...
	mTex1 = new Texture(md3dDevice, L"../Assets/Textures/CubeFaces.tga");
	mTex2 = new Texture(md3dDevice, L"../Assets/Textures/CrateFace.tga");
	mTex3 = new Texture(md3dDevice, L"../Assets/Textures/AlignmentTest.tga");

	/****************************************/

	pModel1 = new Model(md3dDevice, Model::PreMadeModels::UnitBoxSixFaceTexture);
	pModel2 = new Model(md3dDevice, Model::PreMadeModels::UnitBoxRepeatedTexture);
	pModel3 = new Model(md3dDevice, Model::PreMadeModels::UnitPyramidRepeatedTexture);
...
void DXApp::DrawScene()
{
	...
	//multiple view and project matrix once
	//Matrix mWVP = mCam.getViewMatrix() * mCam.getProjMatrix();
	...
	pShaderTexture->SendWorld(mWorld1);
	...
	pShaderTexture->SendWorld(mWorld2);

	pModel2->Render(md3dImmediateContext);

	//Object 3
	mTex3->SetToContext(md3dImmediateContext);
	pModel3->SetToContext(md3dImmediateContext);

	pShaderTexture->SendWorld(mWorld3);
