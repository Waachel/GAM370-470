...
SkyBox::SkyBox(ID3D11Device* dev, float len)
{
	...
	vind += 4;
	tind += 2;
	pVerts[vind].set(0.5f * len, 0.5f * len, -0.5f * len, 0.25, 0.333, Colors::Cyan);			//top left
	pVerts[vind + 1].set(-0.5f * len, 0.5f * len, -0.5f * len, 0.5, 0.333, Colors::Cyan);		//top right
	...
	vind += 4;
	tind += 2;
	pVerts[vind].set(0.5f * len, 0.5f * len, -0.5f * len, 0.25, 0.334, Colors::Cyan);			//bottom left
	pVerts[vind + 1].set(-0.5f * len, 0.5f * len, -0.5f * len, 0.5, 0.334, Colors::Cyan);	//bottom right
	pVerts[vind + 2].set(-0.5f * len, 0.5f * len, 0.5f * len, 0.5, 0, Colors::Cyan);			// top right
	pVerts[vind + 3].set(0.5f * len, 0.5f * len, 0.5f * len, 0.25, 0, Colors::Cyan);			//top left
	pTriList[tind].set(vind, vind + 1, vind + 2);
	pTriList[tind + 1].set(vind, vind + 2, vind + 3);
	...
	vind += 4;
	tind += 2;
	pVerts[vind].set(0.5f * len, -0.5f * len, 0.5f * len, 0.5, 0.666, Colors::Cyan);				  //top right
	pVerts[vind + 1].set(-0.5f * len, -0.5f * len, 0.5f * len, 0.25, 0.666, Colors::Cyan);			  //top left
	pVerts[vind + 2].set(-0.5f * len, -0.5f * len, -0.5f * len, 0.25, 1, Colors::Cyan);		  //bottom left
	pVerts[vind + 3].set(0.5f * len, -0.5f * len, -0.5f * len, 0.5, 1, Colors::Cyan);			  //bottom right
	pTriList[tind].set(vind, vind + 1, vind + 2);
	pTriList[tind + 1].set(vind, vind + 2, vind + 3);
