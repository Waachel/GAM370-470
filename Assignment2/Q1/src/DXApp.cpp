...
void DXApp::InitDemo()
{
	...
	SimpleVertex vertices[] =
	{
		...
		{ Vect(0.2f, -0.2f, 0), Colors::Yellow }, //3
		{ Vect(0.8f, 0.0f, 0), Colors::Red }, //4
		{ Vect(-0.8f, 0.0f, 0), Colors::Blue }, //5
		{ Vect(0.0f, 0.8f, 0), Colors::Lime }, //6
		{ Vect(0.0f, -0.8f, 0), Colors::Magenta }, //7
		//*/
	};
