...
void DXApp::InitDemo()
{
	...
	{
		/*
		{ Vect(0.5f, 0.5f, 0), Colors::Red },
		{ Vect(-0.5f, 0.5f, 0), Colors::Lime },
		{ Vect(-0.5f, -0.5f, 0), Colors::Blue },
		{ Vect(0.5f, -0.5f, 0), Colors::Magenta }
		//*/

		//*
		// Don't forget to change the vertex count!
		// Upper triangle
		//{ Vect(0.5f, 0.5f, 0), Colors::Lime },
		//{ Vect(-0.5f, 0.5f, 0), Colors::Lime },
		//{ Vect(-0.5f, -0.5f, 0), Colors::Lime },
		...
		//*
		{ Vect(0.2f, 0.2f, 0), Colors::Yellow },//0
		{ Vect(-0.2f, 0.2f, 0), Colors::Yellow }, //1
		{ Vect(-0.2f, -0.2f, 0), Colors::Yellow }, //2

		{ Vect(0.2f, 0.2f, 0), Colors::Yellow },//0 //3
		{ Vect(-0.2f, -0.2f, 0), Colors::Yellow }, //2 //4
		{ Vect(0.2f, -0.2f, 0), Colors::Yellow }, //3 //5

		{ Vect(0.2f, 0.2f, 0), Colors::Red },//0 //6
		{ Vect(0.2f, -0.2f, 0), Colors::Red }, //3 //7
		{ Vect(0.8f, 0.0f, 0), Colors::Red }, //4 //8

		{ Vect(-0.2f, 0.2f, 0), Colors::Blue }, //1 //9
		{ Vect(-0.2f, -0.2f, 0), Colors::Blue }, //2 //10
		{ Vect(-0.8f, 0.0f, 0), Colors::Blue }, //5 //11

		{ Vect(0.2f, 0.2f, 0), Colors::Lime },//0 //12
		{ Vect(-0.2f, 0.2f, 0), Colors::Lime }, //1 //13
		{ Vect(0.0f, 0.8f, 0), Colors::Lime }, //6 //14

		{ Vect(-0.2f, -0.2f, 0), Colors::Magenta }, //2 //15
		{ Vect(0.2f, -0.2f, 0), Colors::Magenta }, //3 //16
		{ Vect(0.0f, -0.8f, 0), Colors::Magenta }, //7 //17
		//*/
	};
