...
void DXApp::InitDemo()
{
	...
	hr = CompileShaderFromFile(L"../Assets/Shaders/ColorSelected.hlsl", "VS", "vs_4_0", &pVSBlob);
	if (FAILED(hr))
	{
		MessageBox(nullptr,
	...
	D3D11_INPUT_ELEMENT_DESC layout[] =
	{
		...
		{ "COLOR", 0, DXGI_FORMAT_R32G32B32A32_UINT, 0, 16 , D3D11_INPUT_PER_VERTEX_DATA, 0 }
	};
	...
	hr = CompileShaderFromFile(L"../Assets/Shaders/ColorSelected.hlsl", "PS", "ps_4_0", &pPSBlob);
	if (FAILED(hr))
	{
		MessageBox(nullptr,
	...
	{
		//Vect(0.0f, 0.5f, 0),	// Top 
		//Vect(0.5f, -0.5f, 0),	// Bottom right
		//Vect(-0.5f, -0.5f, 0),	// Bottom left

		//*
		{ Vect(0.2f, 0.2f, 0), 0 },//0
		{ Vect(-0.2f, 0.2f, 0), 0 }, //1
		{ Vect(-0.2f, -0.2f, 0), 0 }, //2

		{ Vect(0.2f, 0.2f, 0), 0 },//0 //3
		{ Vect(-0.2f, -0.2f, 0), 0 }, //2 //4
		{ Vect(0.2f, -0.2f, 0), 0 }, //3 //5

		{ Vect(0.2f, 0.2f, 0), 1 },//0 //6
		{ Vect(0.2f, -0.2f, 0), 1 }, //3 //7
		{ Vect(0.8f, 0.0f, 0), 1 }, //4 //8

		{ Vect(-0.2f, 0.2f, 0), 1 }, //1 //9
		{ Vect(-0.2f, -0.2f, 0), 1 }, //2 //10
		{ Vect(-0.8f, 0.0f, 0), 1 }, //5 //11

		{ Vect(0.2f, 0.2f, 0), 1 },//0 //12
		{ Vect(-0.2f, 0.2f, 0), 1 }, //1 //13
		{ Vect(0.0f, 0.8f, 0), 1 }, //6 //14

		{ Vect(-0.2f, -0.2f, 0), 1 }, //2 //15
		{ Vect(0.2f, -0.2f, 0), 1 }, //3 //16
		{ Vect(0.0f, -0.8f, 0), 1 }, //7 //17
		//*/
	};
	...
	bd.ByteWidth = sizeof(SimpleVertex) * vectLength;	// size of verts * num of verts
	...
	// Setting a color once
	CBColor cbMyColor;
	cbMyColor.col[0] = Colors::Magenta;
	cbMyColor.col[1] = Colors::Lime;
