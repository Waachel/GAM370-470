...
void DXApp::InitDemo()
{
	...
	//pModel1 = new Model(md3dDevice, "../Assets/Models/cottage.azul");
	//pModel1 = new Model(md3dDevice, "../Assets/Models/chest.azul");
	//pModel1 = new Model(md3dDevice, "../Assets/Models/chair.azul");
	pModel1 = new Model(md3dDevice, "../Assets/Models/castle2.azul");
	//pModel1 = new Model(md3dDevice, Model::UnitBoxRepeatedTexture);
	pModel2 = new Model(md3dDevice, Model::UnitBox);
	pTex1 = new Texture(md3dDevice, L"../Assets/Textures/castlestone.tga", D3D11_FILTER_MIN_MAG_MIP_LINEAR);

	GraphObj1 = new GraphicObject_TextureLight(pShaderTextureLight, pModel1, mCam, pTex1);
	GraphObj1->SetColor(Colors::White);

	GraphObj2 = new GraphicObject_TextureLight(pShaderTextureLight, pModel2, mCam, pTex1);
	GraphObj2->SetColor(Colors::LightBlue);

	// Initialize the world matrix
	mWorld1 = Matrix(SCALE, .1f, .1f, .1f) *Matrix(ROT_Y, 90);
