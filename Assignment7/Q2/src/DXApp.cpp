...
void DXApp::InitDemo()
{
	...
	GraphObj1 = new GraphicObject_ColorLight(pShaderColorLight, pModel1, mCam);
	GraphObj1->SetColor(Colors::Red);

	GraphObj2 = new GraphicObject_ColorLight(pShaderColorLight, pModel2, mCam);
	...
	pTex1->SetToContext(md3dImmediateContext);
