...
void DXApp::DrawScene()
{
	...
	//*/
	pShaderTexLight->SetFogParameters(5, 25, Vect(0.098039225f, 0.098039225f, 0.439215720f, 1));

	//pShaderTexLight->SetFogParameters(5, 25, Vect(0.000000000f, 0.000000000f, 0.000000000f, 1));
	...
	pShaderTexLight->SendWorldAndMaterial(planeMat, Colors::LightGreen, 1 * Colors::LightGreen, Vect(.7, .7, .7, 150));
	pPlane->Render(md3dImmediateContext);
	pShaderTexLight->SendWorldAndMaterial(planeMat2, Colors::LightGreen, 1 * Colors::LightGreen, Vect(.7, .7, .7, 150));
	pPlane->Render(md3dImmediateContext);
