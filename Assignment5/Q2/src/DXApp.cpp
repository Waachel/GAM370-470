...
void DXApp::InitDirect3D()
{
	...
	rd.FillMode = D3D11_FILL_SOLID;  // Also: D3D11_FILL_WIREFRAME D3D11_FILL_SOLID
...
void DXApp::InitDemo()
{
	...
	pModTerrain = new TerrainModel(md3dDevice, L"../Assets/Textures/heightmap.tga", 100, 20, 0, 1, 1);
	//pPlane = new FlatPlane(md3dDevice, 10, 1, 1);
	...
	mCam.setOrientAndPosition(Vect(0, 1, 0), Vect(0, 0, -30), Vect(0, 12, -20));
...
void DXApp::DrawScene()
{
	...
	// --- Render plane;
	pModTerrain->Render(md3dImmediateContext);  // Homework...
