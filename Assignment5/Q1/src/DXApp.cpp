...
void DXApp::InitDirect3D()
{
	...
	rd.FrontCounterClockwise = false; // true for RH forward facing
	rd.DepthBias = 0;
...
void DXApp::InitDemo()
{
	...
	//* Flat Plane
	//pPlane = new FlatPlane(md3dDevice, 2, 1, 1);
	...
	/* Flat Plane with repeats
	pPlane = new FlatPlane(md3dDevice, 2, 3, 2);
	mTex1 = new Texture(md3dDevice, L"../Assets/Textures/AlignmentTest.tga", D3D11_FILTER_MIN_MAG_MIP_POINT);
	//mTex1 = new Texture(md3dDevice, L"../Assets/Textures/grassBad.tga", D3D11_FILTER_MIN_MAG_MIP_POINT);
    //mTex1 = new Texture(md3dDevice, L"../Assets/Textures/sandgrass.tga", D3D11_FILTER_MIN_MAG_MIP_POINT);
	//*/

	/* Flat Plane with repeats with problems
	pPlane = new FlatPlane(md3dDevice, 1000, 100, 100);
	//pPlane = new FlatPlane(md3dDevice, 1000, 300, 300);
	mTex1 = new Texture(md3dDevice, L"../Assets/Textures/sandgrass.tga", D3D11_FILTER_MIN_MAG_MIP_LINEAR);
	//mTex1 = new Texture(md3dDevice, L"../Assets/Textures/test2.tga", D3D11_FILTER_MIN_MAG_MIP_POINT);
	//mTex1 = new Texture(md3dDevice, L"../Assets/Textures/test2.tga", D3D11_FILTER_MIN_MAG_MIP_LINEAR);
	//mTex1 = new Texture(md3dDevice, L"../Assets/Textures/brick.tga", D3D11_FILTER_MIN_MAG_MIP_POINT);
	//mTex1 = new Texture(md3dDevice, L"../Assets/Textures/brick.tga", D3D11_FILTER_MIN_MAG_MIP_LINEAR);
	//*/
...
void DXApp::DrawScene()
{
	...
	//wcdata.World = Matrix(TRANS, 0, -5, 0);
